   ...
   for taskname = 1:length(tasknames)
       ...
       try
           ...
           if strcmp(task,'task-aid')
               D = D_aid;
           elseif strcmp(task,'task-ilt_run-1')
               D = D_ilt1;
           elseif strcmp(task,'task-ilt_run-2')
               D = D_ilt2;
           end
    ...
    %        var_names=[var_names1 var_names2];
           ...
           for i = 1 : length(var_names)
               ...
               var =   data{index(i)}(1:volumes_of_interest); % cut variable to length of volumes of interest
