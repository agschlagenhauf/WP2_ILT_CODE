...
chktabl={};  
  ...
  for sub = 1:size(list_sub_data_paths,1)%subjects to run
    ...
    matlabbatch{9}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.mflags.template = {'C:\Users\musialm\spm12\toolbox\FieldMap\T1.nii'};
    ...
    matlabbatch{11}.spm.spatial.preproc.tissue(1).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,1'};
    ...
    matlabbatch{11}.spm.spatial.preproc.tissue(2).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,2'};
    ...
    matlabbatch{11}.spm.spatial.preproc.tissue(3).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,3'};
    ...
    matlabbatch{11}.spm.spatial.preproc.tissue(4).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,4'};
    ...
    matlabbatch{11}.spm.spatial.preproc.tissue(5).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,5'};
    ...
    matlabbatch{11}.spm.spatial.preproc.tissue(6).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,6'};
    ...
    matlabbatch{15}.spm.spatial.normalise.write.subj.resample(4) = cfg_dep('Image Calculator: ImCalc Computed Image: brain', substruct('.','val', '{}',{13}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    ...
    matlabbatch{17}.spm.util.imcalc.outdir(1) = cfg_dep('Get Pathnames: Directories (unique)', substruct('.','val', '{}',{12}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','up'));
