...
main_path='S:\AG\AG-Schlagenhauf_TRR265\Daten\B01\WP2_DATA\derivatives\02_spm12_1st_level\PH_withC_group_n58_constant_feedback_+_sensoric';
...
PEs = readtable(fullfile(main_path, 'fmri_PEs_PH_withC_hierarchical_nortype_n58.txt'));
pcs = readtable(fullfile(main_path, 'fmri_choiceprobs_PH_withC_hierarchical_nortype_n58.txt'));
...
% Make Einzelstats folder and save parametric modulators
    ...
    fold=fullfile(main_path, subject);
     ...
     subj_PEs_block1 = table2array(subj_PEs(subj_PEs.block == 1, 3));
     subj_PEs_block2 = table2array(subj_PEs(subj_PEs.block == 2, 3));
     ...
     subj_pcs_block1 = table2array(subj_pcs(subj_pcs.block == 1, 3));
     subj_pcs_block2 = table2array(subj_pcs(subj_pcs.block == 2, 3));
