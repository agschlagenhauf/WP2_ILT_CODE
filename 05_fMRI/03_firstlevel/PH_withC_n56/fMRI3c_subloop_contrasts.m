...
first_level_path = fullfile(meta_path, 'PH_withC_n58_constant_feedback_+_sensoric_correctbaseline\');
...
N=N+1; tb(N,:)={ N 'Tcon' 'none' 'sensoric_alc'         [0 0 0 1]};
...
N=N+1; tb(N,:)={ N 'Tcon' 'none' 'sensoric_jui'         [zeros(1,29), 0 0 0 1]};
...
N=N+1; tb(N,:)={ N 'Tcon' 'none' 'sensoric'             [0 0 0 1, zeros(1,25), 0 0 0 1]};
