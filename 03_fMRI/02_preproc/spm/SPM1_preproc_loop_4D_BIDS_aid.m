...
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '.*task-aid_bold.nii$';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{3}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^sub.*\task-aid.nii$)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{3}.spm.util.exp_frames.frames = 1;
matlabbatch{4}.spm.temporal.st.scans{1}(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^sub.*\task-aid.nii$)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{4}.spm.temporal.st.nslices = 60;
matlabbatch{4}.spm.temporal.st.tr = 0.869;
matlabbatch{4}.spm.temporal.st.ta = 0.854516666666667;
matlabbatch{4}.spm.temporal.st.so = [0 0.595 0.34 0.085 0.68 0.425 0.17 0.7625 0.51 0.255 0 0.595 0.34 0.085 0.68 0.425 0.17 0.7625 0.51 0.255 0 0.595 0.34 0.085 0.68 0.425 0.17 0.7625 0.51 0.255 0 0.595 0.34 0.085 0.68 0.425 0.17 0.7625 0.51 0.255 0 0.595 0.34 0.085 0.68 0.425 0.17 0.7625 0.51 0.255 0 0.595 0.34 0.085 0.68 0.425 0.17 0.7625 0.51 0.255];
matlabbatch{4}.spm.temporal.st.refslice = 0;
matlabbatch{4}.spm.temporal.st.prefix = 'a';
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.data.presubphasemag.phase = file_name_phase;
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.data.presubphasemag.magnitude = file_name_magnitude;
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.et = [5.19 7.65];
...
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.tert = 60.0301;
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.epifm = 0;
...
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.mflags.template = {'C:\spm12\toolbox\FieldMap\T1.nii'};
...
matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.session.epi(1) = cfg_dep('Expand image frames: Expanded filename list.', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{6}.spm.spatial.realignunwarp.data.scans(1) = cfg_dep('Slice Timing: Slice Timing Corr. Images (Sess 1)', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','files'));
...
matlabbatch{7}.spm.spatial.preproc.channel.vols(1) = cfg_dep('Named File Selector: anat(1) - Files', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
...
matlabbatch{7}.spm.spatial.preproc.tissue(1).tpm = {'C:\spm12\tpm\TPM.nii,1'};
...
matlabbatch{7}.spm.spatial.preproc.tissue(2).tpm = {'C:\spm12\tpm\TPM.nii,2'};
...
matlabbatch{7}.spm.spatial.preproc.tissue(3).tpm = {'C:\spm12\tpm\TPM.nii,3'};
...
matlabbatch{7}.spm.spatial.preproc.tissue(4).tpm = {'C:\spm12\tpm\TPM.nii,4'};
...
matlabbatch{7}.spm.spatial.preproc.tissue(5).tpm = {'C:\spm12\tpm\TPM.nii,5'};
...
matlabbatch{7}.spm.spatial.preproc.tissue(6).tpm = {'C:\spm12\tpm\TPM.nii,6'};
...
matlabbatch{10}.spm.spatial.coreg.estimate.ref(1) = cfg_dep('Realign & Unwarp: Unwarped Mean Image', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','meanuwr'));
matlabbatch{10}.spm.spatial.coreg.estimate.source(1) = cfg_dep('Image Calculator: ImCalc Computed Image: brain', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{12}.spm.spatial.smooth.prefix = 's6';
...
matlabbatch{13}.spm.spatial.normalise.write.subj.resample(1) = cfg_dep('Coregister: Estimate: Coregistered Images', substruct('.','val', '{}',{10}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','cfiles'));
...
matlabbatch{15}.spm.util.imcalc.outdir(1) = cfg_dep('Get Pathnames: Directories (unique)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','up'));
