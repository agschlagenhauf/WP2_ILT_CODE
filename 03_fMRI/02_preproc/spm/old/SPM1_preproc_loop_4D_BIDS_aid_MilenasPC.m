...
chktabl={};  
  ...
  for sub = 1:size(list_sub_data_paths,1)%subjects to run
    ...
    matlabbatch{3}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (.*task-aid_bold.nii$)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    matlabbatch{3}.spm.util.exp_frames.frames = 1;
    matlabbatch{4}.spm.temporal.st.scans{1}(1) = cfg_dep('File Selector (Batch Mode): Selected Files (.*task-aid_bold.nii$)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    ...
    matlabbatch{5}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.mflags.template = {'C:\Users\musialm\spm12\toolbox\FieldMap\T1.nii'};
    ...
    matlabbatch{7}.spm.spatial.preproc.tissue(1).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,1'};
    ...
    matlabbatch{7}.spm.spatial.preproc.tissue(2).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,2'};
    ...
    matlabbatch{7}.spm.spatial.preproc.tissue(3).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,3'};
    ...
    matlabbatch{7}.spm.spatial.preproc.tissue(4).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,4'};
    ...
    matlabbatch{7}.spm.spatial.preproc.tissue(5).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,5'};
    ...
    matlabbatch{7}.spm.spatial.preproc.tissue(6).tpm = {'C:\Users\musialm\spm12\tpm\TPM.nii,6'};
    ...
    matlabbatch{11}.spm.spatial.normalise.write.subj.resample(2) = cfg_dep('Image Calculator: ImCalc Computed Image: brain', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    ...
    matlabbatch{13}.spm.util.imcalc.output = 'binary_brainmask';
    matlabbatch{13}.spm.util.imcalc.outdir(1) = cfg_dep('Get Pathnames: Directories (unique)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','up'));
    matlabbatch{13}.spm.util.imcalc.expression = 'i1>10';
