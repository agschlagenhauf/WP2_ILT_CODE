---
title: "Acces Hierarchical Group*Reinforcer Type Main Model Results"
...
if (sample == 'n71') {
  ...
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_int_rtype_n71.RData")) # stan_data
} else if (sample == 'n58') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n58.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_int_rtype_n58.RData")) # stan_data
} else if (sample == 'n56') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n56.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_int_rtype_n56.RData")) # stan_data
}
