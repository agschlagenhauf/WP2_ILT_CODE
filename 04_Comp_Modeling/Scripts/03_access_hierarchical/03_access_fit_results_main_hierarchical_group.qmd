---
title: "Acces Hierarchical Group Main Model Results"
...
fit_file <- 'fit_n58_2024-04-12_bandit2arm_delta_main_hierarchical_group_estimation1_delta0.9_stepsize0.5.rds'
...
if (sample == 'n71') {
  ...
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_n71.RData")) # stan_data
} else if (sample == 'n58') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n58.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_n58.RData")) # stan_data
} else if (sample == 'n56') {
