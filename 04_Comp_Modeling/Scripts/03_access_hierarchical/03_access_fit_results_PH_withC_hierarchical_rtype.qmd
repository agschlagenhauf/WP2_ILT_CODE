...
fit_file <- 'fit_n56_2024-02-29_bandit2arm_delta_PH_withC_hierarchical_rtype_estimation1_delta0.9_stepsize0.5.rds'
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, paste('Params_PH_withC_red_hierarchical_rtype_', sample, '.txt', sep="")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, paste('fmri_PEs_PH_withC_hierarchical_rtype_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, paste('fmri_Qs_PH_withC_hierarchical_rtype_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, paste('fmri_choiceprobs_PH_withC_hierarchical_rtype_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(k_summary_df, file=file.path(out_path, paste('fmri_ks_PH_withC_hierarchical_rtype_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
