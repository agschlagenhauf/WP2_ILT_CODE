...
Only use this block if you're running the previous part of the script to create the initial sample used for behavioral analyses. If you want to analyse behavioral data of the final sample, uncomment this block.
...
# write.table(ID_excl_c, file=file.path(data_path, paste('WP2_ILT_DATA/Behav/ID_excluded_n', 71-length(ID_excl_c), '.txt', sep="")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
...
png("taste_crave.png", width = 22, height = 10, units='cm', res = 600)
fig_taste_crave
dev.off()
```
...
anova(m_correct_log_1,m_correct_log_2,m_correct_log_3)

tab_model(m_correct_log_3,
...
anova(m_win_stay_log_1,m_win_stay_log_2,m_win_stay_log_3)
...
anova(m_nowin_switch_log_1,m_nowin_switch_log_2,m_nowin_switch_log_3)
