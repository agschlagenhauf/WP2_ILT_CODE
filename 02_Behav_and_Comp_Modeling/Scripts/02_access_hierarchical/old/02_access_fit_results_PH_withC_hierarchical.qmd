...
fit_file <- 'fit_n_71_2024-01-17_bandit2arm_delta_PH_withC_hierarchical_estimation1_delta0.9_stepsize0.5.rds'
...
-   **A**, **tau**: transformed visit-in-subject-level parameters in appropriate range (0-1 for alpha, 0-20 for tau)
...
if (estimation==1) {
  ...
  per_subject_param_names <- c("A[1,1]", "A[2,1]", "A[2,1]", "A[4,1]", "A[5,1]", "A[6,1]", "A[7,1]", "A[8,1]", "A[9,1]", "A[10,1]", "A[11,1]", "A[12,1]", "A[1,2]", "A[2,2]", "A[2,2]", "A[4,2]", "A[5,2]", "A[6,2]", "A[7,2]", "A[8,2]", "A[9,2]", "A[10,2]", "A[11,2]", "A[12,2]")
