...
fit_file <- 'fit_n_71_2024-01-09_bandit2arm_delta_main_rep_hierarchical_estimation1_delta0.9_stepsize0.5.rds'
...
names(params) <- c("ID_block", "alpha", "tau", "pi")
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, 'Params_main_rep_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
