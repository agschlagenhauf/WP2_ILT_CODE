...
fit_file <- 'fit_n56_2024-02-21_bandit2arm_delta_PH_withC_red_hierarchical_omega_estimation1_delta0.99_stepsize0.1.rds'
...
if (sample == 'n71') {
  ...
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_n56.RData")) # stan_data
} else if (sample == 'n53') {
...
if (estimation==1) {
  ...
  parameter_names <- c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_int_m[1,1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A",
                      "mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau",
                      "mu[3]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma",
                      "mu[4]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
                      "C_vars[20]", "mu_C",
                      "mu[5]", "omega_sub_m[1]", "omega_sub_con_m[1]", "omega_int_m[1,1]", "omega_subj_s", "omega_subj_raw[20]",
                      "omega[20,1]", "omega[20,2]", "omega_normal[20,1]", "omega_normal[20,2]",
                      "omega_vars[20]", "mu_omega")
...
```{r}
traceplot(fit, pars=c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_int_m[1,1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A"), inc_warmup=T)

traceplot(fit, pars=c("mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"), inc_warmup=T)

traceplot(fit, pars=c("mu[3]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma"), inc_warmup=T)

traceplot(fit, pars=c("mu[4]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
                      "C_vars[20]", "mu_C"), inc_warmup=T)

traceplot(fit, pars=c("mu[5]", "omega_sub_m[1]", "omega_sub_con_m[1]", "omega_int_m[1,1]", "omega_subj_s", "omega_subj_raw[20]",
                      "omega[20,1]", "omega[20,2]", "omega_normal[20,1]", "omega_normal[20,2]",
                      "omega_vars[20]", "mu_omega"), inc_warmup=T)
```
...
```{r}
stan_hist(fit, pars=c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_int_m[1,1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A"))

stan_hist(fit, pars=c("mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"))

stan_hist(fit, pars=c("mu[3]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma"))
          
stan_hist(fit, pars=c("mu[4]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
                      "C_vars[20]", "mu_C"))

stan_hist(fit, pars=c("mu[5]", "omega_sub_m[1]", "omega_sub_con_m[1]", "omega_int_m[1,1]", "omega_subj_s", "omega_subj_raw[20]",
                      "omega[20,1]", "omega[20,2]", "omega_normal[20,1]", "omega_normal[20,2]",
                      "omega_vars[20]", "mu_omega"))
```
...
```{r}
plot(fit, pars=c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_int_m[1,1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[3]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[4]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
                      "C_vars[20]", "mu_C"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[5]", "omega_sub_m[1]", "omega_sub_con_m[1]", "omega_int_m[1,1]", "omega_subj_s", "omega_subj_raw[20]",
                      "omega[20,1]", "omega[20,2]", "omega_normal[20,1]", "omega_normal[20,2]",
                      "omega_vars[20]", "mu_omega"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")
```
...
```{r}
# mean across iterations of all chains
omega_summary <- as.matrix(summary(fit, pars = "omega")$summary[, c("mean")]) 
```
...
params$C <- C_summary
params$omega <- omega_summary
names(params) <- c("ID_block", "alpha", "tau", "gamma", "C", "omega")
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, paste('Params_PH_withC_red_hierarchical_omega_', sample, '.txt', sep="")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, paste('fmri_PEs_PH_withC_hierarchical_omega_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, paste('fmri_Qs_PH_withC_hierarchical_omega_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, paste('fmri_choiceprobs_PH_withC_hierarchical_omega_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(k_summary_df, file=file.path(out_path, paste('fmri_ks_PH_withC_red_hierarchical_omega_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
