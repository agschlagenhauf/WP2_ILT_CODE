...
fit_file <- 'fit_n60_aud_2024-02-12_bandit2arm_delta_PH_withC_red_hierarchical_pergroup_estimation1_delta0.99_stepsize0.5.rds'
...
if (sample == 'n71') {
  ...
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_pergroup_n60_aud.RData")) # stan_data
} else if (sample == 'n60_hc') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n60.RData")) # Behav and redcap data
  behav_final_redcap <- behav_final_redcap[behav_final_redcap$aud_group=='HC',]
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_pergroup_n60_hc.RData")) # stan_data
} 
...
behav_final_redcap <- behav_final_redcap %>%
  ...
  group_by(ID,ID_block,reinforcer_type,block) %>%
