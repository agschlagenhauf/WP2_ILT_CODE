...
fit_file <- 'fit_n56_2024-02-27_bandit2arm_delta_PH_withC_DU_fixalpha_red_hierarchical_estimation1_delta0.8_stepsize0.5.rds'
...
if (estimation==1) {
  ...
  parameter_names <- c("mu[1]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau",
                      "mu[2]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma",
                      "mu[3]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
...
```{r}
traceplot(fit, pars=c("mu[1]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"), inc_warmup=T)

traceplot(fit, pars=c("mu[2]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma"), inc_warmup=T)

traceplot(fit, pars=c("mu[3]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
...
```{r}
stan_hist(fit, pars=c("mu[1]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"))

stan_hist(fit, pars=c("mu[2]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma"))
          
stan_hist(fit, pars=c("mu[3]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
                      "C_vars[20]", "mu_C"))
```
...
```{r}
plot(fit, pars=c("mu[1]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_int_m[1,1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[2]", "gamma_sub_m[1]", "gamma_sub_con_m[1]", "gamma_int_m[1,1]", "gamma_subj_s", "gamma_subj_raw[20]",
                      "gamma[20,1]", "gamma[20,2]", "gamma_normal[20,1]", "gamma_normal[20,2]",
                      "gamma_vars[20]", "mu_gamma"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[3]", "C_sub_m[1]", "C_sub_con_m[1]", "C_int_m[1,1]", "C_subj_s", "C_subj_raw[20]",
                      "C_const[20,1]", "C_const[20,2]", "C_normal[20,1]", "C_normal[20,2]",
                      "C_vars[20]", "mu_C"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")
```
...
params$C <- C_summary
names(params) <- c("ID_block", "tau", "gamma", "C")
