...
fit_file <- 'fit_n_71_2024-01-09_bandit2arm_delta_PH_withC_rep_hierarchical_estimation1_delta0.9_stepsize0.5.rds'
...
-   mu: overall group-level means of learning rate (alpha), inverse temperature (tau), gamma, C, and Pi (across all subjects and sessions)
...
-   **A**, **tau**, **gamma**, **C**, **pi_normal**: transformed visit-in-subject-level parameters in appropriate range (0-1 for alpha, 0-20 for tau)

-   **_normal**: visit-in-subject-level parameters, not yet in appropriate range (except for parameter pi)
...
if (estimation==1) {
  ...
  parameter_names <- c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_int_m[1,1]", "A_visit_s", "A_subj_s[1]", "A_subj_s[2]", 
                      ...
                      "mu[5]", "pi_sub_m[1]", "pi_sub_con_m[1]", "pi_int_m[1,1]", "pi_visit_s", "pi_subj_s[1]", "pi_subj_s[2]", 
...
traceplot(fit, pars=c("mu[5]", "pi_sub_m[1]", "pi_sub_con_m[1]", "pi_int_m[1,1]", "pi_visit_s", "pi_subj_s[1]", "pi_subj_s[2]", 
                      "pi_visit_raw[20,1]", "pi_visit_raw[20,2]", "pi_subj_raw[1,20]",
                      "pi_subj_raw[2,20]", "pi_normal[20,1]", "pi_normal[20,2]",
...
stan_hist(fit, pars=c("mu[5]", "pi_sub_m[1]", "pi_sub_con_m[1]", "pi_int_m[1,1]", "pi_visit_s", "pi_subj_s[1]", "pi_subj_s[2]", 
                      "pi_visit_raw[20,1]", "pi_visit_raw[20,2]", "pi_subj_raw[1,20]",
                      "pi_subj_raw[2,20]", "pi_normal[20,1]", "pi_normal[20,2]",
                      "pi_vars[20,1]", "pi_vars[20,2]", "mu_pi"))
```
...
plot(fit, pars=c("mu[5]", "pi_sub_m[1]", "pi_sub_con_m[1]", "pi_int_m[1,1]", "pi_visit_s", "pi_subj_s[1]", "pi_subj_s[2]", 
                      "pi_visit_raw[20,1]", "pi_visit_raw[20,2]", "pi_subj_raw[1,20]",
                      "pi_subj_raw[2,20]", "pi_normal[20,1]", "pi_normal[20,2]",
                      "pi_vars[20,1]", "pi_vars[20,2]", "mu_pi"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")
...
sum(posterior$pi_normal>0)/length(posterior$pi_normal)
```
...
names(params) <- c("ID_block", "alpha", "tau", "gamma", "C", "pi")
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, 'Params_PH_withC_rep_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, 'fmri_PEs_PH_withC_rep_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, 'fmri_Qs_PH_withC_rep_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, 'fmri_choiceprobs_PH_withC_rep_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
...
if (estimation==1) {
  write.table(k_summary_df, file=file.path(out_path, 'fmri_ks_PH_withC_rep.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
