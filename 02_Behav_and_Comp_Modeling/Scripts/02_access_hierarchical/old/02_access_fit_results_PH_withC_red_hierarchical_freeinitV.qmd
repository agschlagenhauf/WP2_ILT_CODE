...
fit_file <- 'fit_n56_2024-02-21_bandit2arm_delta_PH_withC_red_hierarchical_freeinitV_estimation1_delta0.99_stepsize0.1.rds'
...
if (estimation==1) {
  ...
  parameter_names <- c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_int_m[1,1]", "A_subj_s", "A_subj_raw[20]",
                      ...
                      "C_vars[20]", "mu_C",
                      "mu[5]", "initV_sub_m[1]", "initV_sub_con_m[1]", "initV_int_m[1,1]", "initV_subj_s", "initV_subj_raw[20]",
                      "initV[20,1]", "initV[20,2]", "initV_normal[20,1]", "initV_normal[20,2]",
                      "initV_vars[20]", "mu_initV")
...
traceplot(fit, pars=c("mu[5]", "initV_sub_m[1]", "initV_sub_con_m[1]", "initV_int_m[1,1]", "initV_subj_s", "initV_subj_raw[20]",
                      "initV[20,1]", "initV[20,2]", "initV_normal[20,1]", "initV_normal[20,2]",
                      "initV_vars[20]", "mu_initV"), inc_warmup=T)
```
...
stan_hist(fit, pars=c("mu[5]", "initV_sub_m[1]", "initV_sub_con_m[1]", "initV_int_m[1,1]", "initV_subj_s", "initV_subj_raw[20]",
                      "initV[20,1]", "initV[20,2]", "initV_normal[20,1]", "initV_normal[20,2]",
                      "initV_vars[20]", "mu_initV"))
```
...
plot(fit, pars=c("mu[5]", "initV_sub_m[1]", "initV_sub_con_m[1]", "initV_int_m[1,1]", "initV_subj_s", "initV_subj_raw[20]",
                      "initV[20,1]", "initV[20,2]", "initV_normal[20,1]", "initV_normal[20,2]",
                      "initV_vars[20]", "mu_initV"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")
```
...
```{r}
# mean across iterations of all chains
initV_summary <- as.matrix(summary(fit, pars = "initV")$summary[, c("mean")]) 
```
...
params$C <- C_summary
params$initV <- initV_summary
names(params) <- c("ID_block", "alpha", "tau", "gamma", "C", "initV")
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, paste('Params_PH_withC_red_hierarchical_initV_', sample, '.txt', sep="")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, paste('fmri_PEs_PH_withC_hierarchical_initV_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, paste('fmri_Qs_PH_withC_hierarchical_initV_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, paste('fmri_choiceprobs_PH_withC_hierarchical_initV_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(k_summary_df, file=file.path(out_path, paste('fmri_ks_PH_withC_initV_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
