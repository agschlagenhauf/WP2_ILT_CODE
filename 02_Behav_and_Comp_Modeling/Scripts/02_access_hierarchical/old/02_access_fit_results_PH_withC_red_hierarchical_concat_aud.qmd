---
title: "Acces Hierarchical Pearce-Hall with C Model Results"
...
fit_file <- 'fit_n60_aud_2024-02-13_bandit2arm_delta_PH_withC_red_hierarchical_concat_estimation1_delta0.99_stepsize0.5.rds'
...
if (sample == 'n71') {
  ...
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_n71.RData")) # stan_data
} else if (sample == 'n63') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n63.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_n63.RData")) # stan_data
} else if (sample == 'n60') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n60.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_n60.RData")) # stan_data
} else if (sample == 'n53') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n53.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_n53.RData")) # stan_data
} else if (sample == 'n50') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n50.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_n50.RData")) # stan_data
} else if (sample == 'n60_aud') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n60.RData")) # Behav and redcap data
  behav_final_redcap <- behav_final_redcap[behav_final_redcap$aud_group=='AUD',]
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_concat_n60_aud.RData")) # stan_data
} else if (sample == 'n60_hc') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n60.RData")) # Behav and redcap data
  behav_final_redcap <- behav_final_redcap[behav_final_redcap$aud_group=='HC',]
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_PH_withC_red_hierarchical_concat_n60_hc.RData")) # stan_data
} 
...
if (estimation==1) {
  ...
  parameter_names <- c("mu_jui[1]", "A_subj_s", "A_subj_raw_jui[20]",
                      "A_jui[20]", "A_normal_jui[20]",
                      "A_vars_jui[20]", "mu_A_jui",
                      "mu_alc[1]", "A_subj_raw_alc[20]",
                      "A_alc[20]", "A_normal_alc[20]",
                      "A_vars_alc[20]", "mu_A_alc",
                      "mu_jui[2]", "tau_subj_raw_jui[20]",
                      "tau_jui[20]", "tau_normal_jui[20]",
                      "tau_vars_jui[20]", "mu_tau_jui",
                      "mu_alc[2]", "tau_subj_raw_alc[20]",
                      "tau_alc[20]", "tau_normal_alc[20]",
                      "tau_vars_alc[20]", "mu_tau_alc",
                      "mu_jui[3]", "gamma_subj_raw_jui[20]",
                      "gamma_jui[20]", "gamma_normal_jui[20]",
                      "gamma_vars_jui[20]", "mu_gamma_jui",
                      "mu_alc[3]", "gamma_subj_raw_alc[20]",
                      "gamma_alc[20]", "gamma_normal_alc[20]",
                      "gamma_vars_alc[20]", "mu_gamma_alc",
                      "mu_jui[4]", "C_subj_raw_jui[20]",
                      "C_const_jui[20]", "C_normal_jui[20]",
                      "C_vars_jui[20]", "mu_C_jui",
                      "mu_alc[4]", "C_subj_raw_alc[20]",
                      "C_const_alc[20]", "C_normal_alc[20]",
                      "C_vars_alc[20]", "mu_C_alc")
...
```{r}
traceplot(fit, pars=c("mu_jui[1]", "A_subj_s", "A_subj_raw_jui[20]",
                      "A_jui[20]", "A_normal_jui[20]",
                      "A_vars_jui[20]", "mu_A_jui",
                      "mu_alc[1]", "A_subj_raw_alc[20]",
                      "A_alc[20]", "A_normal_alc[20]",
                      "A_vars_alc[20]", "mu_A_alc"), inc_warmup=T)

traceplot(fit, pars=c("mu_jui[2]", "tau_subj_raw_jui[20]",
                      "tau_jui[20]", "tau_normal_jui[20]",
                      "tau_vars_jui[20]", "mu_tau_jui",
                      "mu_alc[2]", "tau_subj_raw_alc[20]",
                      "tau_alc[20]", "tau_normal_alc[20]",
                      "tau_vars_alc[20]", "mu_tau_alc"), inc_warmup=T)

traceplot(fit, pars=c("mu_jui[3]", "gamma_subj_raw_jui[20]",
                      "gamma_jui[20]", "gamma_normal_jui[20]",
                      "gamma_vars_jui[20]", "mu_gamma_jui",
                      "mu_alc[3]", "gamma_subj_raw_alc[20]",
                      "gamma_alc[20]", "gamma_normal_alc[20]",
                      "gamma_vars_alc[20]", "mu_gamma_alc"), inc_warmup=T)

traceplot(fit, pars=c("mu_jui[4]", "C_subj_raw_jui[20]",
                      "C_const_jui[20]", "C_normal_jui[20]",
                      "C_vars_jui[20]", "mu_C_jui",
                      "mu_alc[4]", "C_subj_raw_alc[20]",
                      "C_const_alc[20]", "C_normal_alc[20]",
                      "C_vars_alc[20]", "mu_C_alc"), inc_warmup=T)
```
...
```{r}
stan_hist(fit, pars=c("mu_jui[1]", "A_subj_s", "A_subj_raw_jui[20]",
                      "A_jui[20]", "A_normal_jui[20]",
                      "A_vars_jui[20]", "mu_A_jui",
                      "mu_alc[1]", "A_subj_raw_alc[20]",
                      "A_alc[20]", "A_normal_alc[20]",
...
stan_hist(fit, pars=c("mu_jui[2]", "tau_subj_raw_jui[20]",
                      "tau_jui[20]", "tau_normal_jui[20]",
                      "tau_vars_jui[20]", "mu_tau_jui",
                      "mu_alc[2]", "tau_subj_raw_alc[20]",
                      "tau_alc[20]", "tau_normal_alc[20]",
...
stan_hist(fit, pars=c("mu_jui[3]", "gamma_subj_raw_jui[20]",
                      "gamma_jui[20]", "gamma_normal_jui[20]",
                      "gamma_vars_jui[20]", "mu_gamma_jui",
                      "mu_alc[3]", "gamma_subj_raw_alc[20]",
                      "gamma_alc[20]", "gamma_normal_alc[20]",
...
stan_hist(fit, pars=c("mu_jui[4]", "C_subj_raw_jui[20]",
                      "C_const_jui[20]", "C_normal_jui[20]",
                      "C_vars_jui[20]", "mu_C_jui",
                      "mu_alc[4]", "C_subj_raw_alc[20]",
                      "C_const_alc[20]", "C_normal_alc[20]",
...
```{r}
plot(fit, pars=c("mu_jui[1]", "A_subj_s", "A_subj_raw_jui[20]",
                      "A_jui[20]", "A_normal_jui[20]",
                      "A_vars_jui[20]", "mu_A_jui",
                      "mu_alc[1]", "A_subj_raw_alc[20]",
                      "A_alc[20]", "A_normal_alc[20]",
...
plot(fit, pars=c("mu_jui[2]", "tau_subj_raw_jui[20]",
                      "tau_jui[20]", "tau_normal_jui[20]",
                      "tau_vars_jui[20]", "mu_tau_jui",
                      "mu_alc[2]", "tau_subj_raw_alc[20]",
                      "tau_alc[20]", "tau_normal_alc[20]",
...
plot(fit, pars=c("mu_jui[3]", "gamma_subj_raw_jui[20]",
                      "gamma_jui[20]", "gamma_normal_jui[20]",
                      "gamma_vars_jui[20]", "mu_gamma_jui",
                      "mu_alc[3]", "gamma_subj_raw_alc[20]",
                      "gamma_alc[20]", "gamma_normal_alc[20]",
...
plot(fit, pars=c("mu_jui[4]", "C_subj_raw_jui[20]",
                      "C_const_jui[20]", "C_normal_jui[20]",
                      "C_vars_jui[20]", "mu_C_jui",
                      "mu_alc[4]", "C_subj_raw_alc[20]",
                      "C_const_alc[20]", "C_normal_alc[20]",
...
A_jui_summary <- as.matrix(summary(fit, pars = "A_jui")$summary[, c("mean")])
A_alc_summary <- as.matrix(summary(fit, pars = "A_alc")$summary[, c("mean")]) 
```
...
```{r}
# mean across iterations of all chains
tau_jui_summary <- as.matrix(summary(fit, pars = "tau_jui")$summary[, c("mean")]) 
tau_alc_summary <- as.matrix(summary(fit, pars = "tau_alc")$summary[, c("mean")])
```
...
```{r}
# mean across iterations of all chains
gamma_jui_summary <- as.matrix(summary(fit, pars = "gamma_jui")$summary[, c("mean")]) 
gamma_alc_summary <- as.matrix(summary(fit, pars = "gamma_alc")$summary[, c("mean")]) 
```
...
```{r}
# mean across iterations of all chains
C_jui_summary <- as.matrix(summary(fit, pars = "C_const_jui")$summary[, c("mean")]) 
C_alc_summary <- as.matrix(summary(fit, pars = "C_const_alc")$summary[, c("mean")]) 
```

## Save parameter estimates together with ID, reinforcer type, aud group information

```{r}
params <- as.data.frame(unique(behav_final_redcap$ID))
params$alpha_jui <- A_jui_summary
params$alpha_alc <- A_alc_summary
params$tau_jui <- tau_jui_summary
params$tau_alc <- tau_alc_summary
params$gamma_jui <- gamma_jui_summary
params$gamma_alc <- gamma_alc_summary
params$C_jui <- C_jui_summary
params$C_alc <- C_alc_summary
names(params) <- c("ID_block", "alpha_jui", "alpha_alc", "tau_jui", "tau_alc", "gamma_jui", "gamma_alc", "C_jui", "C_alc")

params

if (estimation==1) {
  write.table(params, file=file.path(out_path, paste('Params_PH_withC_red_hierarchical_concat_', sample, '.txt', sep="")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, paste('fmri_PEs_PH_withC_hierarchical_concat_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, paste('fmri_Qs_PH_withC_hierarchical_concat_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, paste('fmri_choiceprobs_PH_withC_hierarchical_concat_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(k_summary_df, file=file.path(out_path, paste('fmri_ks_PH_withC_concat_', sample, '.txt', sep = "")), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
