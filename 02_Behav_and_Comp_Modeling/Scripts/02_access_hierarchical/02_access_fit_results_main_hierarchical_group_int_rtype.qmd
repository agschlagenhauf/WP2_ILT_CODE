...
if (estimation==1) {
  write.table(params, file=file.path(out_path, 'Params_main_hierarchical_group_int_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, 'fmri_PEs_main_hierarchical_group_int_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, 'fmri_Qs_main_hierarchical_group_int_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, 'fmri_choiceprobs_main_hierarchical_group_int_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
