...
fit_file <- 'fit_n58_2024-04-12_bandit2arm_delta_main_hierarchical_group_rtype_estimation1_delta0.9_stepsize0.5.rds'
...
if (sample == 'n71') {
  ...
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_rtype_n71.RData")) # stan_data
} else if (sample == 'n58') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n58.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_rtype_n58.RData")) # stan_data
} else if (sample == 'n56') {
  load(file.path(behavpath,"Behav/behav_final_redcap_n56.RData")) # Behav and redcap data
  load(file.path(behavpath,"Input/stan_data_bandit2arm_delta_main_hierarchical_group_rtype_n56.RData")) # stan_data
}
...
if (estimation==1) {
  ...
  parameter_names <- c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A",
                      "mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_subj_s", "tau_subj_raw[20]",
...
```{r}
traceplot(fit, pars=c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A"), inc_warmup=T)

traceplot(fit, pars=c("mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
...
```{r}
stan_hist(fit, pars=c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A"))

stan_hist(fit, pars=c("mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"))
```
...
```{r}
plot(fit, pars=c("mu[1]", "A_sub_m[1]", "A_sub_con_m[1]", "A_subj_s", "A_subj_raw[20]",
                      "A[20,1]", "A[20,2]", "A_normal[20,1]", "A_normal[20,2]",
                      "A_vars[20]", "mu_A"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")

plot(fit, pars=c("mu[2]", "tau_sub_m[1]", "tau_sub_con_m[1]", "tau_subj_s", "tau_subj_raw[20]",
                      "tau[20,1]", "tau[20,2]", "tau_normal[20,1]", "tau_normal[20,2]",
                      "tau_vars[20]", "mu_tau"),
     show_density = FALSE, ci_level = 0.5, outer_level = 0.95, fill_color = "salmon")
```
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, 'Params_main_hierarchical_group_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(PE_summary_df, file=file.path(out_path, 'fmri_PEs_main_hierarchical_group_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = T)
}
```
...
if (estimation==1) {
  write.table(Q_summary_df, file=file.path(out_path, 'fmri_Qs_main_hierarchical_group_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
...
if (estimation==1) {
  write.table(pc_summary_df, file=file.path(out_path, 'fmri_choiceprobs_main_hierarchical_group_rtype.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = F)
}
```
