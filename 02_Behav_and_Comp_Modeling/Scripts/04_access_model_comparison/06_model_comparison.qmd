...
## Load Stan fit files
```{r}
fit_file_main <- 'fit_n56_2024-02-28_bandit2arm_delta_PH_withC_estimation1_delta0.9_stepsize0.5.rds'
fit_file_main_DU <- 'fit_n56_2024-02-29_bandit2arm_delta_main_DU_estimation1_delta0.99_stepsize0.1.rds'
fit_file_PH_withC <- 'fit_n56_2024-03-01_bandit2arm_delta_PH_withC_estimation1_delta0.99_stepsize0.1.rds'
fit_file_PH_withC_DU <- 'fit_n56_2024-03-01_bandit2arm_delta_PH_withC_DU_estimation1_delta0.99_stepsize0.1.rds'
...
env_main <- new.env()
elpd_main <- load(file.path(out_path, "elpd_kfold_bandit2arm_delta_main_n56.RData"),env_main)[1]
env_main_DU <- new.env()
elpd_main_DU <- load(file.path(out_path, "elpd_kfold_bandit2arm_delta_main_DU_n56.RData"),env_main_DU)[1]
env_PH_withC <- new.env()
elpd_PH_withC <- load(file.path(out_path, "elpd_kfold_bandit2arm_delta_PH_withC_n56.RData"),env_PH_withC)[1]
env_PH_withC_DU <- new.env()
elpd_PH_withC_DU <- load(file.path(out_path, "elpd_kfold_bandit2arm_delta_PH_withC_DU_n56.RData"),env_PH_withC_DU)[1]
```
...
## Load Stan fit file
```{r}
fit_file_PH_withC_hierarchical_group <- 'fit_n56_2024-02-29_bandit2arm_delta_PH_withC_hierarchical_group_estimation1_delta0.9_stepsize0.5.rds'
...
elpd_PH_withC_hierarchical_group <- load(file.path(out_path, "elpd_kfold_bandit2arm_delta_PH_withC_hierarchical_group_n56.RData"),env_PH_withC__hierarchical_group)[1]
```
