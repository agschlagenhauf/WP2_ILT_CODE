...
orig_file <- 'fit_n58_2024-04-12_bandit2arm_delta_PH_withC_estimation1_delta0.99_stepsize0.1.rds'
...
sim_file <- 'sim_2024-04-13_bandit2arm_delta_PH_withC_sim_n58.rds'
sim_fit <- readRDS(file.path(out_path, 'Parameter_Recovery', sim_file)) # Stan model output

# load simulated data fitting results
recovery_file <- 'recovery_2024-04-13_bandit2arm_delta_PH_withC_n58.rds'
