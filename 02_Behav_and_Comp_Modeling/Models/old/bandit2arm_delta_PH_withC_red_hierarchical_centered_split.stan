...
parameters {
  ...
  vector[kV] A_sub_con_m_1;    // learning rate
  vector[kV] tau_sub_con_m_1;  // inverse temperature
  vector[kV] gamma_sub_con_m_1;  // decay constant
  vector[kV] C_sub_con_m_1;  // arbitrary constant
  
  vector[kV] A_sub_con_m_2;    // learning rate
  vector[kV] tau_sub_con_m_2;  // inverse temperature
  vector[kV] gamma_sub_con_m_2;  // decay constant
  vector[kV] C_sub_con_m_2;  // arbitrary constant
  ...
  //centered parameterization effect on subj-level
  vector[N] A_subj_c;
  vector[N] tau_subj_c;
  vector[N] gamma_subj_c;
  vector[N] C_subj_c;
...
transformed parameters {
  ...
  A_sub_con_m[kV] = A_sub_con_m_1[kV] + A_sub_con_m_2[kV];
  tau_sub_con_m[kV] = tau_sub_con_m_1[kV] + tau_sub_con_m_2[kV];
  gamma_sub_con_m[kV] = gamma_sub_con_m_1[kV] + gamma_sub_con_m_2[kV];
  C_sub_con_m[kV] = C_sub_con_m_1[kV] + C_sub_con_m_2[kV];
  ...
  for (s in 1:N) {
    ...
    for (v in 1:C) { // for every condition
      ...
      A_normal[s,v] = A_subj_c[s]; // fixed intercept + random intercept per subject
      tau_normal[s,v] = tau_subj_c[s];
      gamma_normal[s,v] = gamma_subj_c[s];
      C_normal[s,v] = C_subj_c[s];
...
model {
  ...
  A_sub_con_m_1 ~ normal(0,1);
  tau_sub_con_m_1 ~ normal(0,1);
  gamma_sub_con_m_1 ~ normal(0,1);
  C_sub_con_m_1 ~ normal(0,1);
  
  A_sub_con_m_2 ~ normal(0,1);
  tau_sub_con_m_2 ~ normal(0,1);
  gamma_sub_con_m_2 ~ normal(0,1);
  C_sub_con_m_2 ~ normal(0,1);
  ...
  //A_subj_s ~ normal(0,1);
  //tau_subj_s ~ normal(0,1);
  //gamma_subj_s ~ normal(0,1);
  //C_subj_s ~ normal(0,1);
    
  //centered ariance effect on subj-level effects
  A_subj_c ~ normal(mu[1],A_subj_s);
  tau_subj_c ~ normal(mu[2],tau_subj_s);
  gamma_subj_c ~ normal(mu[3],gamma_subj_s);
  C_subj_c ~ normal(mu[4],C_subj_s);
